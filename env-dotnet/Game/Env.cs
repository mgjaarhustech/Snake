...
namespace Snake.EnvServer.Game
{
    ...
    public sealed class Env
    {
        ...
        private readonly bool[] _occ;        // occupancy grid
        private Random _rng;                 // reseeded on Reset/Seed
        ...
        {
            // keep deterministic but avoid 0
        ...
        public record StepOut(float[] Signals, bool Done, int Score, int Length, string Death, int Steps);
        ...
        // ---- Accessors used by the service / encoders
        ...
        // Provide an immutable snapshot for encoders
        public Obs.Snapshot Snapshot()
            => new Obs.Snapshot(Cols, Rows, Head, Direction, Food, _body.ToArray());
